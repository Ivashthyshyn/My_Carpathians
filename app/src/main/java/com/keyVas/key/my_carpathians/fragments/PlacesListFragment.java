...
public class PlacesListFragment extends Fragment implements IRotation {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
		...
		emptyView = fragmentView.findViewById(R.id.emptyViewForPlace);
		imageForEmptyView = fragmentView.findViewById(R.id.emptyImage);
		recyclerView = fragmentView.findViewById(R.id.recyclerViewForPlace);
		return fragmentView;
	}
