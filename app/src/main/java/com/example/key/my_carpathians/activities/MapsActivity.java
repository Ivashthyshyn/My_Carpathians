...
import com.example.key.my_carpathians.utils.OfflineRegionActionModeCallback;
...
import static com.example.key.my_carpathians.utils.LocationService.WAIT_MODE;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, CommunicatorMapActivity {
	...
	public void saveCreatedObject(int model, String name) {
		if (model == PLACE && mMarker != null) {
			...
			StorageSaveHelper storageSaveHelper = new StorageSaveHelper(MapsActivity.this, mRootPathString);
			Rout mRout = new Rout();
